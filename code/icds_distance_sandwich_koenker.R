...
distance_maintau_eps = function(main_tau_eps){
  ...
  for (i in 1:reps){
    ...
    ans = sandwichKNG(data = data, total_eps = total_eps, tau = tau, 
                      ...
                      method = "koenker", lower_accept = 0.2, upper_accept = 0.25,
...
filename = paste("../output/sandwich_data_sd_", t, "_e",total_eps, ".Rdata", sep = "")

save(list = c("sandwich_koenker_int", "sandwich_koenker_slope", "sandwich_koenker_l2",
